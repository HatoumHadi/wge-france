    ...
    public function run()
    {
        ...
        \DB::table('categories')->insert(array(
            ...
            5 =>
                array(
                    'id' => 6,
                    'name' => '{"ar": "فلكسو", "en": "Flexo", "fr": "Flexo"}',
                    'description' => '{"ar": "آلة طباعة تستخدم ألواح مطاطية مرنة، مثالية للطباعة على مواد التغليف مثل البلاستيك والورق المقوى", "en": "A printing machine that uses flexible rubber plates, ideal for printing on packaging materials like plastic and cardboard", "fr": "Une machine d`impression utilisant des plaques en caoutchouc souples, idéale pour l`impression sur des matériaux d`emballage tels que le plastique et le carton"}',
                    'parent_id' => NULL,
                    'created_at' => '2025-01-08 12:50:00',
                    'updated_at' => '2025-01-08 12:50:00',
                ),
